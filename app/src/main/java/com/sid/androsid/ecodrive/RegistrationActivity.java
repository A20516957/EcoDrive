                ...
                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (task.isSuccessful()){
                            ...
                            User user = new User();
                            user.setEmail(email);
                            user.setUsername(email.substring(0, email.indexOf("@")));//Todo -- write the logic for calculation IDEA
                            ...
                            mDatabaseReference.push().setValue(user.getUsername());
        ...
        switch (view.getId()){
            case R.id.registerB:{
                ...
                if(!isEmpty(mEmail.getText().toString())
                        ...
                        Log.i("h",(mPassword.getText().toString()+(mConfirmPassword.getText().toString())));
